 ...
 * @author zaikov
 */
public class SessionsComparator implements Comparator<QSession> {
    private String str1, str2;
    private int pos1, pos2, len1, len2;
    
    @Override
    public int compare(QSession p1, QSession p2) {
        str1 = p1.getUser().getName();
        str2 = p2.getUser().getName();
