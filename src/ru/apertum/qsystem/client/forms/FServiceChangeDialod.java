...
public class FServiceChangeDialod extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel13.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel13.text")); // NOI18N
        jLabel13.setName("jLabel13"); // NOI18N

        jLabel15.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel15.text")); // NOI18N
        ...
        jLabel21.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel21.text")); // NOI18N
        jLabel21.setName("jLabel21"); // NOI18N

        textFieldPrefix.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("textFieldPrefix.text")); // NOI18N
        textFieldPrefix.setName("textFieldPrefix"); // NOI18N

        jLabel22.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel22.text")); // NOI18N
        jLabel22.setName("jLabel22"); // NOI18N

        textFieldServiceName.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("textFieldServiceName.text")); // NOI18N
        textFieldServiceName.setName("textFieldServiceName"); // NOI18N

        jLabel23.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel23.text")); // NOI18N
        jLabel23.setName("jLabel23"); // NOI18N

        textFieldServiceDescript.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("textFieldServiceDescript.text")); // NOI18N
        textFieldServiceDescript.setName("textFieldServiceDescript"); // NOI18N

        jLabel1.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel1.text")); // NOI18N
        ...
        jLabel2.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel2.text")); // NOI18N
        ...
        jLabel8.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel8.text")); // NOI18N
        jLabel8.setName("jLabel8"); // NOI18N

        checkBoxResultRequired.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("checkBoxResultRequired.text")); // NOI18N
        checkBoxResultRequired.setName("checkBoxResultRequired"); // NOI18N

        checkBoxInputRequired.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("checkBoxInputRequired.text")); // NOI18N
        ...
        jLabel4.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel4.text")); // NOI18N
        jLabel4.setName("jLabel4"); // NOI18N

        textFieldInputCaption.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("textFieldInputCaption.text")); // NOI18N
        ...
        jLabel3.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel3.text")); // NOI18N
        ...
        jLabel5.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel5.text")); // NOI18N
        ...
        labelDayLimit.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("labelDayLimit.text")); // NOI18N
        labelDayLimit.setName("labelDayLimit"); // NOI18N

        labelLimitForOnePerson.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("labelLimitForOnePerson.text")); // NOI18N
        labelLimitForOnePerson.setName("labelLimitForOnePerson"); // NOI18N

        jLabel10.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel10.text")); // NOI18N
        jLabel10.setName("jLabel10"); // NOI18N

        textFieldTicketText.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("textFieldTicketText.text")); // NOI18N
        textFieldTicketText.setName("textFieldTicketText"); // NOI18N

        jLabel11.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel11.text")); // NOI18N
        ...
        jLabel12.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel12.text")); // NOI18N
        jLabel12.setName("jLabel12"); // NOI18N

        jLabel19.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel19.text")); // NOI18N
        ...
        jLabel20.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel20.text")); // NOI18N
        ...
        jLabel25.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel25.text")); // NOI18N
        jLabel25.setName("jLabel25"); // NOI18N

        jLabel26.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel26.text")); // NOI18N
        jLabel26.setName("jLabel26"); // NOI18N

        jLabel28.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel12.text")); // NOI18N
        ...
        cbRequaredAsColumnExt.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("cbRequaredAsColumnExt.text")); // NOI18N
        cbRequaredAsColumnExt.setName("cbRequaredAsColumnExt"); // NOI18N

        tfTabloText.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("tfTabloText.text")); // NOI18N
        tfTabloText.setName("tfTabloText"); // NOI18N

        labelTabloText.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("labelTabloText.text")); // NOI18N
        labelTabloText.setName("labelTabloText"); // NOI18N

        jLabel29.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel29.text")); // NOI18N
        jLabel29.setName("jLabel29"); // NOI18N

        spDataAsNumber.setModel(new javax.swing.SpinnerNumberModel(0, 0, 15, 1));
        spDataAsNumber.setName("spDataAsNumber"); // NOI18N

        jLabel30.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel30.text")); // NOI18N
        ...
        jTabbedPane1.addTab(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jPanel3.TabConstraints.tabTitle"), jPanel3); // NOI18N

        jPanel4.setName("jPanel4"); // NOI18N

        jLabel24.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel24.text")); // NOI18N
        ...
        labelCaptionButton.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("labelCaptionButton.text")); // NOI18N
        ...
        textAreaButtonCaption.setFont(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getFont("textAreaButtonCaption.font")); // NOI18N
        textAreaButtonCaption.setRows(5);
        textAreaButtonCaption.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("textAreaButtonCaption.text")); // NOI18N
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jPanel6.border.title"))); // NOI18N
        jPanel6.setName("jPanel6"); // NOI18N

        spinButX.setModel(new javax.swing.SpinnerNumberModel(0, 0, 2000, 10));
        spinButX.setName("spinButX"); // NOI18N

        jLabel14.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel14.text")); // NOI18N
        jLabel14.setName("jLabel14"); // NOI18N

        spinButY.setModel(new javax.swing.SpinnerNumberModel(0, 0, 2000, 10));
        spinButY.setName("spinButY"); // NOI18N

        jLabel16.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel16.text")); // NOI18N
        jLabel16.setName("jLabel16"); // NOI18N

        spinButB.setModel(new javax.swing.SpinnerNumberModel(100, 50, 2000, 10));
        spinButB.setName("spinButB"); // NOI18N

        jLabel17.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel17.text")); // NOI18N
        jLabel17.setName("jLabel17"); // NOI18N

        spinButH.setModel(new javax.swing.SpinnerNumberModel(50, 50, 2000, 10));
        spinButH.setName("spinButH"); // NOI18N

        jLabel18.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel18.text")); // NOI18N
        ...
        WysiwygButton.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("WysiwygButton.text")); // NOI18N
        ...
        jTabbedPane1.addTab(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jPanel4.TabConstraints.tabTitle"), jPanel4); // NOI18N
        ...
        jLabel7.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel7.text")); // NOI18N
        jLabel7.setName("jLabel7"); // NOI18N

        jScrollPane3.setName("jScrollPane3"); // NOI18N

        textAreaTextPrint.setColumns(20);
        textAreaTextPrint.setFont(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getFont("textAreaTextPrint.font")); // NOI18N
        ...
        jLabel6.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel6.text")); // NOI18N
        jLabel6.setName("jLabel6"); // NOI18N

        jScrollPane2.setName("jScrollPane2"); // NOI18N

        textAreaInfoHtml.setColumns(20);
        textAreaInfoHtml.setFont(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getFont("textAreaInfoHtml.font")); // NOI18N
        ...
        butWYS2.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("butWYS2.text")); // NOI18N
        ...
        labelInfoDialog.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("labelInfoDialog.text")); // NOI18N
        ...
        jTabbedPane1.addTab(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jPanel5.TabConstraints.tabTitle"), jPanel5); // NOI18N

        jPanel7.setName("jPanel7"); // NOI18N

        cbSound.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("cbSound.text")); // NOI18N
        cbSound.setName("cbSound"); // NOI18N

        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jPanel8.border.title"))); // NOI18N
        jPanel8.setName("jPanel8"); // NOI18N

        jPanel9.setBorder(javax.swing.BorderFactory.createTitledBorder(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jPanel9.border.title"))); // NOI18N
        jPanel9.setName("jPanel9"); // NOI18N

        bgGong.add(rbNoGong);
        rbNoGong.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("rbNoGong.text")); // NOI18N
        rbNoGong.setName("rbNoGong"); // NOI18N

        bgGong.add(rbGong);
        rbGong.setSelected(true);
        rbGong.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("rbGong.text")); // NOI18N
        rbGong.setName("rbGong"); // NOI18N

        bgGong.add(rbGongFirstOnly);
        rbGongFirstOnly.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("rbGongFirstOnly.text")); // NOI18N
        ...
        cbClient.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("cbClient.text")); // NOI18N
        cbClient.setName("cbClient"); // NOI18N

        cbClientNumber.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("cbClientNumber.text")); // NOI18N
        cbClientNumber.setName("cbClientNumber"); // NOI18N

        cbGoNumber.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("cbGoNumber.text")); // NOI18N
        cbGoNumber.setName("cbGoNumber"); // NOI18N

        jPanel10.setBorder(javax.swing.BorderFactory.createTitledBorder(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jPanel10.border.title"))); // NOI18N
        jPanel10.setName("jPanel10"); // NOI18N

        bgGo.add(rbCabinet);
        rbCabinet.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("rbCabinet.text")); // NOI18N
        rbCabinet.setName("rbCabinet"); // NOI18N

        bgGo.add(rbWindow);
        rbWindow.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("rbWindow.text")); // NOI18N
        rbWindow.setName("rbWindow"); // NOI18N

        bgGo.add(rbStoika);
        rbStoika.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("rbStoika.text")); // NOI18N
        rbStoika.setName("rbStoika"); // NOI18N

        bgGo.add(rbTable);
        rbTable.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("rbTable.text")); // NOI18N
        rbTable.setName("rbTable"); // NOI18N

        bgGo.add(rbNoGo);
        rbNoGo.setSelected(true);
        rbNoGo.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("rbNoGo.text")); // NOI18N
        ...
        jTabbedPane1.addTab(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jPanel7.TabConstraints.tabTitle"), jPanel7); // NOI18N

        checkBoxBackoffice.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("checkBoxBackoffice.text")); // NOI18N
        ...
        tfID.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("tfID.text")); // NOI18N
        tfID.setName("tfID"); // NOI18N

        jLabel27.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jLabel27.text")); // NOI18N
        jLabel27.setName("jLabel27"); // NOI18N

        labelLink.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("labelLink.text")); // NOI18N
        ...
        jButton1.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("jButton1.text")); // NOI18N
        ...
        buttonSave.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("buttonSave.text")); // NOI18N
        ...
        buttonCancel.setText(org.jdesktop.application.Application.getInstance().getContext().getResourceMap(FServiceChangeDialod.class).getString("buttonCancel.text")); // NOI18N
