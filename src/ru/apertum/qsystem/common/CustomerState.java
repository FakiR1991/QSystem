...
public enum CustomerState {
    ...
    STATE_FINISH,
    /**
     * 11 кастомера поместили в отложенные. домой не идет, сидит ждет покуда не вызовут.
     */
    STATE_POSTPONED,
    /**
     * 12 кастомера отправили на оплату счёта
     */
    STATE_PAYMENT,
    /**
     * 13 кастомер должен был вернуться после оплаты счёта в банке,
     * но умер и не дошёл обратно - мы его удалили
     */
    STATE_DEAD_AFTER_PAYMENT,
    /**
     * 14 кастомер оплатил услугу в банке и вернулся к нам
     */
    STATE_WAIT_AFTER_PAYMENT,
    /**
     * 15 с кастомером закончили работать и поместили в отложенные. домой не идет, сидит ждет покуда не вызовут.
     */
    STATE_POSTPONED_AFTER_SERVICE
}